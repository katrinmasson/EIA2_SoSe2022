namespace L08Beach {
    ...
    function drawPalms(_position: Vector): void {
        //Stamm
        ...
        for (let leaves: number = 0; leaves < 5; leaves++) {
    ...
    function woman(_position: Vector): void {
        //Kreis für den Haare
    ...
    function man(_position: Vector): void {
        //Kreis für den Haare
        crc2.fillStyle = "black";
        crc2.save();
        crc2.beginPath();
